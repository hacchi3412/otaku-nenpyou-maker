  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <button
        ...
        className="rounded-full border-2 border-dashed border-[#262230]/40 px-4 py-2 text-sm font-bold text-[#8D869B] transition hover:border-[#262230] hover:text-[#262230]"
      >
        ＋もっと過去の年を追加する
      </button>
    </div>
